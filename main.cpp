...
int main()
{
    ...
    Plante A("Plante A", 0, 0, 0, "Chrysanthème");
    Plante B("Plante B", 0, 0, 0, "Muguet");
    Plante C("Plante C", 0, 0, 0, "Hortensia");
    ...
    while(jour < 10){
        ...
        cout <<"Taper 4 pour verifier les infos de la plante\n"<<endl;
